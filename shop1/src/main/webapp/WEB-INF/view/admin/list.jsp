...
<form action="mailform" method="post">
  ...
  <th>&nbsp;</th>
  <th><input type="checkbox" name="allchk" onchange="allchkbox(this)" class="form-check-input"></th></tr>
  ...
  <td>
    <input type="checkbox" name="idchks" class="idchks" value="${user.userid}" class="form-check-input"></td>
  </tr>
  </c:forEach>
...
<script type="text/javascript">
   function allchkbox(allchk) {
	   $(".idchks").prop("checked",allchk.checked) //전체 선택 또는 해제
   }
</script></body></html>